...
<div class="container">
    ...
    <div class="row justify-content-center">
                                ...
                                <a class="btn btn-success ml-3 mb-2" href="{{ route('admin.create','tipo=1') }}">Adicionar nova casa</a>
                                <a class="btn btn-success ml-3 mb-2" href="{{ route('admin.create','tipo=2') }}">Adicionar novo lote</a>
                                <a class="btn btn-success ml-3 mb-2" href="{{ route('admin.create','tipo=3') }}">Adicionar novo loteamento</a>
